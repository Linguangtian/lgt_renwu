...
<header class="top_header">
    ...
    <div class="title">
        <?php if($show_day == ''): ?>合作商征集<?php endif; ?>
    </div>
</header>
...
<header class="profit-head mt" style="margin-top: 40px">
    ...
    <div class="btm" style="margin-top:2rem;">
        <p style="font-size: 18px;">有需要分布任务的可以联系我们</p>
        <p style="font-size: 20px;">qq群：1060783658</p>
        <p style="font-size: 14px;">QQ号：3378046598</p>

    </div>



    <div class="about" style=" margin-top: 5rem ;text-align: center">

        <img style="" src="/tpl/Public/images/rwxq1.png"/>
