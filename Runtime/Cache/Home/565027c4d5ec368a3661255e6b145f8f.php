...
<div class="login">
    <div class="welcome"><img src="/tpl/Public/images/welcome.png" style="width: 108px;height: 108px;display: block;margin: 0 auto;"></div>
    ...
    <div class="login-form">
        <form class="submit-ajax" action="<?php echo U('reg');?>">
            ...
            <!-- // TODO 修改注册-->
            <div class="reg_email" style="display: none">
            ...
            <div class="reg_phone" >
                ...
                <div class="login-inp" style="background: #f4f4f4;border: none;">
                    ...
                    <input type="button" id="getcode" value="发送验证码" style="background:#ffa71c; color:#FFF; border-radius:5px; height:30px; line-height:30px;" />
                </div>
            </div>
            <!-- // TODO 修改注册-->
        ...
        <!-- <p style="margin-top: -5px;margin-bottom: 10px;width: 80%;margin-left: 10%;font-size: 10px;color: #ffa71c;">*密码需右英文与字母组成，最少6位</p> -->
        
        <div class="login-inp" style="border: none;background: #ffa71c;">
   ...
   <a href="<?php echo U('login');?>">
        	<p style="width: 150px;height: 60px;line-height: 60px;margin: 20px auto 0; "> <span style="width: 20px;height: 20px;border: 1px #000 solid;display: inline-block;margin: 20px 6px 20px 40px;text-align: center;float: left;line-height: 20px;border-radius: 20px;text-align: center;">→</span> 去登陆</p>
        </a>
