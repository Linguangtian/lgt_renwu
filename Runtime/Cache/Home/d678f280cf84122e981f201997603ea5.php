...
<head lang="en">
	...
	<link rel="stylesheet" href="/tpl/Public/css/share.css?7" />
	...
	<style>
		...
		@keyframes message-data-v-4444cd4b {
			0%, to {transform: translateZ(0)} 2%, 10%, 18.5% {transform: translate3d(0, -10%, 0)} 20%, 28.5% {transform: translate3d(0, -20%, 0)} 30%,
			38.5% {transform: translate3d(0, -30%, 0)} 40%, 48.5% {transform: translate3d(0, -40%, 0)} 50%, 58.5% {transform: translate3d(0, -50%, 0)}
			60%, 68.5% {transform: translate3d(0, -60%, 0)}70%, 78.5% {transform: translate3d(0, -70%, 0)} 80%, 88.5% {transform: translate3d(0, -80%, 0)}
...
<body class="index_body">
	...
	<!--标题内容-->
	<div class="index_bt">
		<p class="index_hyxx">Hi,预计上线时间2020.03.05</p>
	</div>
	...
	<div class="index_ye">
		...
		<div class="index_zhyehsy">
			<p class="index_syyys">
				<a  href="<?php echo U('index/about');?>">刷手征集中( <span  class="ungoto"> 加盟 </span> )
				</a>
			</p>
			<p class="index_syyys">
				<a href="/Home/Member/sale.html">征集合作商
				（<span class="ungoto">入驻</span>）
				</a>
			</p>
		</div>
	</div>
				...
				<?php if(is_array($task_list)): $i = 0; $__LIST__ = $task_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><a href="<?php echo U('Task/show',array('id'=>$vo['id']));?>">
						<div style="box-shadow:0px 1px 10px #ccc ;border-radius: 6px;">
							...
							<!-- <div class="index_rw_zxmss">
								<p>【金朋友圈】 用户等级：<span><?php echo ($vo["levelname"]); ?></span> </p>
