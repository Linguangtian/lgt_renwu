...
<table class="table table-striped table-bordered table-hover table-condensed">
    ...
    <?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr>
            ...
            <?php if($vo['type'] == 1): ?><td style="color: green"> +<?php echo ($vo["c_jinbin"]); ?></td>
                <?php else: ?>
                <td style="color: red"> -<?php echo ($vo["c_jinbin"]); ?></td><?php endif; ?>
            <td><?php echo ($vo["dsc"]); ?></td>
