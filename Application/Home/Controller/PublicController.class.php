...
class PublicController extends PublicBaseController
{
    ...
    public function getcode()
    {
        ...
        $content = "【任吾行】您的验证码为{$code}，验证码3分钟内有效。";
    ...
    public function reg()
    {
        ...
        if (IS_POST) {
            ...
            $data['jinbin_point'] = $jinbin;
            $data['total_jinbin'] = $jinbin;
            ...
            if ($res) {
                ...
                //注册人的上级返回金币
                $model_memberaha = new MemberModel();
                $model_memberaha->incJinbin($data['p1'], 20, 3);
                $jinbin_data = [
                    'member_id' => $data['p1'],
                    'c_jinbin'  => 20,
                    'c_type'    => 1,
